--[[
    Note: 
    - Enables rendering of text above a players head
    - Allows to show certain permissions being performed
]]
...
RegisterNetEvent('ext_commands:showFloatingText')
AddEventHandler('ext_commands:showFloatingText', function(target, text)
    table.insert(FloatingText, {target = GetPlayerFromServerId(targer), text = text, life = GetGameTimer() + FloatingTextDuration})
end)
...
Citizen.CreateThread(function()
    ...
    print('[ext-commands]: Overhead text enabled')
